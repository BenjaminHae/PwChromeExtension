...
executeScript(function(){
    ...
    dataReady = function(data) {
        ...
        var evt= new CustomEvent("secretKeyReady", {'detail':{'secretkey': secretkey, 'secretkey0': getpwdstore(salt2), 'session_token': localStorage.session_token, 'confkey': sessionStorage.confusion_key, 'username':getcookie('username') }});
